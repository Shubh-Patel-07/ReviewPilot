        ...
        <div className="relative">
          ...
          {showBusinessDropdown && (
            <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-slate-900 border border-slate-800 shadow-2xl p-2 z-50 text-xs space-y-1">
              ...
              <button className="w-full flex items-center justify-between px-3 py-2 rounded-xl hover:bg-slate-800/50 text-slate-300">
                <span className="flex items-center gap-2">🏋️ Apex Fitness</span>
              </button>
              <div className="border-t border-slate-800 pt-1 mt-1">
                <button className="w-full flex items-center gap-2 px-3 py-2 text-blue-400 hover:bg-blue-500/10 rounded-xl font-medium">
